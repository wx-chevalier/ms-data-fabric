...
public class APIResponse extends Identifiable<APIResponse> {
  ...
  public static APIResponse of(ObjectMapper objectMapper, DcApiResponse dcApiResponse)
      throws IOException {
    ...
    return new APIResponse()
        ...
        .setModel(objectMapper.readValue(dcApiResponse.getResponseModel(), Schema.class));
  }

  public DcApiResponse toEntity(ObjectMapper objectMapper) throws JsonProcessingException {
    return new DcApiResponse().withId(id).withResponseModel(objectMapper.writeValueAsString(model));
  }
}
