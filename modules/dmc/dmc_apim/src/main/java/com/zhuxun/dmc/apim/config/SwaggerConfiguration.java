...
import com.zhuxun.dmc.apim.config.properties.SwaggerProperties;
import com.zhuxun.dmc.apim.dto.api.apiimpl.APIImplTO;
import com.zhuxun.dmc.apim.security.jwt.JWTConfigurer;
...
public class SwaggerConfiguration {
  ...
  public Docket api() {
    ...
    return new Docket(DocumentationType.SWAGGER_2)
        ...
        .additionalModels(
            typeResolver.resolve(APIImplTO.class))
        .select()
